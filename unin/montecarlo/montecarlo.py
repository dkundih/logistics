...
from unin.hub.hub import random_value
from unin.misc.global_functions import *

#shows detailed overview of available functions.
def help():  
    print('*** NOTE: unin.montecarlo works only for sequential data with reasonable standard deviation, otherwise simulated data would expand to infinity.\nIf exponential increase in data is detected, error is raised automatically. ***\n')
    print('unin.montecarlo CALLABLE FUNCTIONS:\n')
    print('.help() - information about the available functions in the unin.montecarlo module.\n * takes no additional arguments.\n')
...
class Configuration:
        ...
        def log(func):
                ...
                def logsaver(self, *args, **kwargs):
                    if self.log_summary == True:
                        ...
                        with open('unin Logs.txt', 'a') as f:
    ...
    def graph(self, graph_title = 'Monte Carlo simulation', x_title = 'X axis', y_title = 'Y axis', plot_size = (25,10)):
        ...
        plt.title('unin (c) David Kundih, 2021.', fontsize = 14, weight = 'regular', loc = 'right')
