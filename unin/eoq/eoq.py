...
def help():  
    print('unin.eoq CALLABLE FUNCTIONS:\n')
    print('.help() - information about the available functions in the unin.eoq module.\n * takes no additional arguments.\n')
...
class Configuration:
    ...
    def help():
        print('unin.eoq.Configuration CALLABLE FUNCTIONS:\n')
        print('.help() - information about the available functions in the unin.eoq.Configuration class.\n * takes no additional arguments.\n')
        print('.execute() - executes the calculation of EOQ over the defined parameters.\n * takes no additional arguments.\n')
        print('.get_logs() - shows the event log of executed functions.\n * takes no additional arguments.\n * Requirements:\n   unin.eoq.Configuration.execute().\n   log_summary = True.\n')
